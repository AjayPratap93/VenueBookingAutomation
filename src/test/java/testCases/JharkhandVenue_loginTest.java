...
public class JharkhandVenue_loginTest  {
	WebDriver driver ;
	...
	String number = RandomData.randomnumber();
	String phone;
	String pass;
	@BeforeClass
	...
	void loginApp() {//String os,String br
		...
		driver.get("https://staging-admin.jharkhandsports.in/admin-login");
	...
	@Test(priority=1)
		...
		p1.username("sajhadb@yopmail.com");	
	...
	void createModuleManager() throws InterruptedException, IOException {
		...
		user.chooseClusterButton();
		WebElement option = driver.findElement(
			    By.xpath("//option[text()='" + TestDataStore.clusterName + "']")
			);
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", option);
		option.click();
		//user.chooseCluster(clusterName);
		user.chooseVenueButton();
		WebElement option1 = driver.findElement(
			    By.xpath("//option[text()='" + TestDataStore.venueName + "']")
			);
			((JavascriptExecutor) driver).executeScript("arguments[0].scrollIntoView(true);", option1);
		option1.click();
		//user.chooseVenue(venueName);
